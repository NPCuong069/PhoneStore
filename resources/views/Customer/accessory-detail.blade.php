...
@section('Product-detail')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-5">
                <div class="content">
                    <h2 class="title" style="text-align:center">{{$data->accesory_name}}</h2>
                    <hr>
                    <div class="content-detail">
                        <p><b>Brand:</b> Oppo</p>
                        <div class="price">
                            <b>Giá bán:</b>
                            <span class="price-detail"><b>{{number_format($data->accesory_price)}}đ</b></span>
                        </div>
                        <div class="discription">
                            <b>Miêu tả:</b> 
                            <p>{{$data->accesory_details}}</p>
                        </div>
                    </div>
                    <hr>
